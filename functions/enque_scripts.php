<?php
  function register_scripts() {
    ...
    $js_file = (defined('PRODUCTION') && constant('PRODUCTION')) ? '/javascript/dist/logan-sausage.min.js' : '/javascript/logan-sausage.js';
    // $vendor = (defined('PRODUCTION') && constant('PRODUCTION')) ? '/javascript/dist/vendor.js' : '/javascript/vendor.js';

    wp_register_script('logan_sausage', $template_dir.$js_file, [], '0.0.1', true);
